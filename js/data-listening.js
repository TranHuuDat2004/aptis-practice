...
part15: [
        ...
        { id: 'topic5', title: '5. Local cultural center', baseKey: 'W-B-M-M', story: '<strong>W</strong>e <strong>B</strong>oth <strong>M</strong>et <strong>M</strong>r. Trump (Cả hai chúng tôi đều đã gặp ông Trump ở trung tâm văn hóa).' },
        { id: 'topic6', title: '6. Community design', baseKey: 'B-M-W-W', story: '<strong>B</strong>oss <strong>M</strong>ust <strong>W</strong>ork <strong>W</strong>ell (Sếp phải làm việc tốt để thiết kế cộng đồng).' },
        { id: 'topic7', title: '7. University and technology', baseKey: 'B-M-W-M', story: '<strong>B</strong>oss <strong>M</strong>uốn <strong>W</strong>ebsite <strong>M</strong>iễn phí.' },
        { id: 'topic8', title: '8. Urban farming', baseKey: 'M-W-W-B', story: '<strong>M</strong>y <strong>W</strong>ife <strong>W</strong>ants <strong>B</strong>eef (Vợ tôi muốn ăn thịt bò từ nông trại đô thị).' },
        { id: 'topic9', title: '9. The subject of beauty', baseKey: 'M-W-B-W', story: '<strong>M</strong>en and <strong>W</strong>omen <strong>B</strong>oth <strong>W</strong>ant beauty (Đàn ông và phụ nữ đều muốn sắc đẹp).' },
        { id: 'topic10', title: '10. Internet', baseKey: 'M-B-W-B', story: '<strong>M</strong>an <strong>B</strong>ought <strong>W</strong>ebsite <strong>B</strong>adly (Người đàn ông đã mua một trang web rất tệ).' },
        { id: 'topic11', title: '11. Music and Singers', baseKey: 'W-B-M-B', story: '<strong>W</strong>oman <strong>B</strong>ought <strong>M</strong>icrophone <strong>B</strong>adly (Người phụ nữ đã mua một cái micro rất tệ).' },
        { 
            id: 'topic12', 
            title: '12. Changes in the work place (Trường hợp đặc biệt)', 
            baseKey: 'M-W-B-M', 
            story: '<strong>M</strong>en and <strong>W</strong>omen <strong>B</strong>oth <strong>M</strong>ove (Đàn ông và phụ nữ đều chuyển chỗ làm việc).',
            isFixed: true
        }
    ],
...
const rawAnswers1617 = [
    // --- Cột 1 ---
    "<strong>Create dedicated periods</strong> for writing & <strong>Refuse to seek the advice</strong> of others",
    "<strong>Series are damaged</strong> by overexposure. & They can <strong>generate negative publicity</strong> for the sport",
    "It caught the <strong> audience's attention</strong> from the start. & <strong>Series are damaged</strong> by overexposure.",
    "<strong>Blocking out noise</strong> and light is a key & The <strong>media overemphasize</strong> the subject",
    "<strong>Maintain a positive attitude</strong> & Our <strong>definition of it is changing</strong>",

    "They have both been <strong>overlooked by academics</strong>. & It is <strong>not always easy for </strong>the meanings to be identified.",
    "It helps to <strong>reach new customers</strong>. & They are <strong>not always good for sport fans</strong>",
    "It <strong>doesn't provide enough</strong> alternatives to driving. & It is <strong>likely to meet resistance</strong> from local communities.",
    "<strong>They seem unrealistic</strong>. & It is <strong>negatively influencing</strong> script production.",
    ...
    "People are <strong>unnecessarily worried</strong> about them & People <strong>should be reassured </strong>by their presence.",
    "It <strong>allows you to be more flexible</strong> & It <strong>prevents you from making mistakes</strong>",
    "<strong>Organize their resources</strong> more effectively & <strong>Get advice from someone</strong> they know who is experienced",

    // --- Cột 2 ---
    "It <strong>wasn't as good as she expected</strong> & It <strong>depends on your situation and personality</strong>",
    "It is <strong>very exciting to read</strong> & It has been written for the <strong>general audience</strong>",
    "They can <strong>cause harmful effects</strong> & <strong>Provides them with a balance</strong> in their lives",
    "They are <strong>difficult to relate to</strong> & It <strong>lacks originality</strong>",
    "The <strong>characters were interesting</strong> & It will establish the<strong> author's popularity</strong>",

    "It has <strong>consistent quality</strong> throughout & <strong>Viewer habits </strong>influence the way that series are made",
    "Its <strong>production techniques</strong> & They should be <strong>released at the right time</strong>",
    "The <strong>dialogues seems unrealistic</strong>. & The <strong>new industry demands</strong> are <strong>negatively influencing</strong> script production",
    "Standard of <strong>service is not good</strong> & They need to make the <strong>customers feel valued</strong> and welcome",
    
    "<strong>He will probably retire</strong> from singing & He could <strong>have been more successful</strong>",
    "It has <strong>not been accurately</strong> reported by the media & The research is <strong>unlikely to find </strong>a conclusive answer",
    ...
    "It <strong>creates an adventure</strong> & It is <strong>only suitable for</strong> a particular generation",

    // --- Cột 3 (bên dưới) ---
    "<strong>They are not typical</strong> of modern buildings & They often display a <strong>lack of ambition</strong>",
    "He <strong>wasn't ready to start</strong> a higher education & <strong>How to be independent</strong>",
    ...
    "<strong>The plot was very strong</strong> & It is <strong>very similar to the author's other books</strong>",
    ...
    "They help you <strong>make decisions</strong> & It <strong>requires you to set</strong> your certain limits",
    "<strong>Monitor your spending</strong> for a weekly plan & <strong>Seek advice from someone</strong> who have experience",
];
